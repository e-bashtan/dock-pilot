...
type FleetInstallationLog struct {
	ID             int64     `json:"id"`
...
type FleetMonitoredService struct {
	ID        uuid.UUID `json:"id"`
...
type FleetRegistrationToken struct {
	ID              uuid.UUID          `json:"id"`
