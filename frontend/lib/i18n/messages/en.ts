export const en = {
  ...
  fleet: {
    ...
    settingsLink: "Farm settings",
    addServer: "Add server",
    loadFailed: "Failed to load farm data",
    ...
    kindPairExistingHint:
      "The remote panel already runs Barn. Use a pairing code from its Farm settings.",
    ...
    removeServerConfirm: "Remove «{name}» from the farm?",
    ...
    device: "Device",
    used: "Used",
    eventsTitle: "Farm events",
    eventsSubtitle: "Recent incidents and alerts across the farm.",
