export const en = {
  ...
  databases: {
    title: "Databases",
    subtitle: "Manage Postgres instances, users, and S3 backups.",
    loadFailed: "Failed to load databases",
    empty: "No Postgres instances yet.",
    ...
    hostPort: "Host port",
    hostPortHint: "Empty = auto-allocate",
    ...
    stop: "Stop",
    delete: "Delete",
    deleteConfirm: "Delete instance «{name}»? Container will be stopped; data volume stays.",
    deploying: "Deploying…",
    ...
    s3PathStyle: "Force path-style",
    retention: "Keep last N",
    enabled: "Enabled",
    runBackup: "Backup now",
    useSchedule: "Use schedule credentials",
