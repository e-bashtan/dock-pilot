export const en = {
  ...
  fleet: {
    ...
    summaryBillingEmpty: "No VPS payment accounts in Payments",
    summaryBillingSet: "{count} servers with billing",
    monitoringLegend:
      "Monitoring: live CPU / RAM / disk from Master poll or agent heartbeat (~30s). Payment: cost and due date from VPS accounts in Payments.",
    ...
    perMonth: "mo",
    billingFormHint:
      "Payment is taken from VPS accounts in Payments (cost and paid-until). Link an account or keep auto-match by IP.",
    billingAccount: "VPS payment account",
    ...
    saveBilling: "Save payment link",
    billingSaved: "Payment link saved",
    billingSaveFailed: "Could not save payment link",
    lastSeen: "Last seen",
    memory: "Memory",
    disk: "Disk",
