export const en = {
  ...
  fleet: {
    ...
    newServerSubtitle: "Pair a remote DockPilot panel or install a monitoring agent over SSH.",
    kindDockpilot: "Remote DockPilot",
    kindDockpilotHint: "Connect another DockPilot instance using a pairing code from its settings.",
    kindAgent: "SSH agent",
    kindAgentHint: "Install the lightweight agent on a VPS without a full DockPilot panel.",
    baseUrl: "Panel URL",
