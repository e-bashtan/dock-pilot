...
export const ru: Messages = {
  ...
  fleet: {
    ...
    summaryBillingEmpty: "Нет аккаунтов оплаты VPS в разделе Оплата",
    summaryBillingSet: "Оплата указана у {count} серверов",
    monitoringLegend:
      "Мониторинг: CPU / RAM / диск с опросов Master или heartbeat агента (~30 с). Оплата: стоимость и срок из аккаунтов VPS в разделе Оплата.",
    ...
    perMonth: "мес",
    billingFormHint:
      "Данные берутся из аккаунтов VPS в разделе Оплата (стоимость и срок). Привяжите аккаунт или оставьте автосопоставление по IP.",
    billingAccount: "Аккаунт оплаты VPS",
    ...
    saveBilling: "Сохранить привязку",
    billingSaved: "Привязка оплаты сохранена",
    billingSaveFailed: "Не удалось сохранить привязку оплаты",
    ...
    removeServerConfirm: "Удалить «{name}» из флота?",
    ...
    enableMasterTitle: "Включить fleet master",
    enableMasterHint:
    ...
    disconnectMasterConfirm: "Отключить этот узел от fleet master?",
