...
export const ru: Messages = {
  ...
  fleet: {
    ...
    settingsLink: "Настройки фермы",
    addServer: "Добавить сервер",
    loadFailed: "Не удалось загрузить данные фермы",
    ...
    kindPairExistingHint:
      "На удалённом VPS панель уже установлена. Нужен код сопряжения из её настроек фермы.",
    ...
    removeServerConfirm: "Удалить «{name}» из фермы?",
